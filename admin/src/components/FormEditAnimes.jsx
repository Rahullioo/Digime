...
const FormEditAnimes = () => {
    ...
    useEffect(()=>{
        const getAnimeById = async()=>{
            try {
                const response = await instance.get(`/animes/${id}`);
    ...
    const updateAnime = async (e)=>{
        e.preventDefault();
        try {
            await instance.patch(`/animes/${id}`,{
                title: title,
                deskripsi: deskripsi,
                image: image,
                genreId: genreId,
  ...
  return (
    <div>
        ...
        <h2 className="subtitle">Update Anime</h2>
                ...
                <div className="content">
                    <form onSubmit={updateAnime} >
                        ...
                        <div className="field">
                            ...
                            <div className="control">
                                <textarea type="text" className="textarea is-success" value={deskripsi} onChange={(e)=>setDeskripsi(e.target.value)} placeholder='Deskripsi' />
                            </div>
                        </div>
                        <div className="field">
